...
const cashbookRoutes            = require('./routes/cashbook');
const trialBalanceRoutes        = require('./routes/trialBalance');
const voucherSubBookRoutes      = require('./routes/voucherSubBook');
const voucherPrintingRoutes     = require('./routes/voucherPrinting');
const brWiseDepositLoanRoutes   = require('./routes/brWiseDepositLoan');
const dailyPositionReportRoutes = require('./routes/dailyPositionReport');
const scrollPrintingRoutes      = require('./routes/scrollPrinting');
const debitEntryReportRoutes    = require('./routes/debitEntryReport');
...
const swaggerOptions = {
  definition: {
    ...
    servers: [{ url: 'https://cbsapi.avsinsotech.com:8596' }],
  },
  apis: ['./routes/*.js'],
};
const swaggerSpec = swaggerJsdoc(swaggerOptions);
...
app.use('/api/cashbook',               cashbookRoutes);
app.use('/api/trial-balance',          trialBalanceRoutes);
app.use('/api/voucher-subbook',        voucherSubBookRoutes);
app.use('/api/voucher-printing',       voucherPrintingRoutes);
app.use('/api/br-wise-deposit-loan',   brWiseDepositLoanRoutes);
app.use('/api/daily-position-report',  dailyPositionReportRoutes);
app.use('/api/scrollprinting',         scrollPrintingRoutes);
app.use('/api/debit-entry-report',     debitEntryReportRoutes);
...
// ── HTTP Timeouts (for long-running reports) ────────────────
server.timeout = 600000;
server.keepAliveTimeout = 600000;
server.headersTimeout = 601000;
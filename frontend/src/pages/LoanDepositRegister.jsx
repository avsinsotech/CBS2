...
//   const [asOnDate, setAsOnDate] = useState("01/06/2026");
...
//         <div style={styles.formRow}>
//           <label style={styles.label}>
//             Sub GLCode : <span style={styles.req}>*</span>
//           </label>
//           <input
...
//           <button style={styles.btnOutline}>DDS Report</button>
//           <button style={styles.btnOutline}>Deposit Report</button>
//           <button style={styles.btnOutline}>Loan Report</button>
//           <button style={styles.btnClose}>Close</button>
//           <button style={styles.btnPrimary}>Loan Report</button>
//           <button style={styles.btnPrimary}>Deposit Report</button>
//           <button style={styles.btnPrimary}>DDS Report</button>
//           <button style={styles.btnPrimary}>Loan Text Report View</button>
//         </div>

//         {/* Buttons Row 2 */}
//         <div style={{ ...styles.btnRow, marginTop: 10 }}>
//           <button style={styles.btnPrimary}>DDS Text Report View</button>
//           <button style={styles.btnPrimary}>Deposit Text Report View</button>
//         </div>

...
//   const handleSummaryPrint = () => alert("Summary Report Print");

//   return (
//     <div className="glw-wrapper">
//       <div className="glw-card">
...
//           <button className="glw-btn" onClick={handleReportPrint}>Report Print</button>
//           <button className="glw-btn" onClick={handleSummaryPrint}>Summary Report Print</button>
//         </div>

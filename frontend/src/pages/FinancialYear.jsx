...
function FinancialYear() {
  ...
  const fetchData = async (mode) => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/api/financial-year?${buildQuery()}`
      );
  ...
  const handleTextDownload = async () => {
    ...
    a.href     = url;
    a.download = `${form.textReportName || "financial-year"}.csv`;
    a.click();
  ...
  return (
    <div className="db-wrapper">
      <div className="db-card no-print">
        ...
        <div className="db-body">
          ...
          <div className="db-row">
            <div className="db-radio-group">
              {["In Thousand", "In Lacs", "In Crore"].map((opt) => (
                <label key={opt} className="db-radio-label fy-radio-label">
                  <input
                    type="radio"
                    name="amountUnit"
                    value={opt}
          ...
          <div className="db-row">
            ...
            <input
              className="db-input fy-input-wide"
              type="text"
              name="textReportName"
      ...
      {/* RESULT SECTION */}
      {fetched && (
        <div className="fy-result-wrapper">

          {/* Section label */}
          <div className="fy-result-label">Financial Year</div>
